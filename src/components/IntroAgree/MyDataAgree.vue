        ...
        <div class="text-center">
          ...
          <v-dialog v-model="dialog" width="500">
            ...
            <v-card>
              ...
              >
              <v-card-text>
                제 1 조 (목적) 이 약관은 주식회사 국민은행(이하 “은행”이라
                합니다)과 “은행”이 제공하는 “연결고리서비 스”(이하 “서비스”라
                합니다)를 이용하는 고객(이하 ”이용자” 라 합니다) 사이의 권리,
                의무 및 책 임사항, “서비스” 제공에 관한 제반 사항을 규정함을
                목적으로 합니다.제 2 조 (용어의 정의) ① 이 약관에서 사용하는
                용어의 의미는 다음과 같습니다. 1. “서비스”라 함은 “이용자”의
                “개인신용정보” 전송요구에 따라 은행, 카드, 보험, 증권, 통신 업권
                또는 공공기관 등에 분산된 이용자의 금융정보 등의
                “개인신용정보”를 통합하여 제 공하는 통합조회 서비스, 자산관리
                서비스, 지출관리 서비스, 기타 “은행”이 제공하는 서비 스를
                의미합니다. 2. “이용자”는 이 약관에 따라 “은행”과 이용 계약을
                체결하고 “은행”으로부터 “서비스” 이용 자격을 부여 받은 고객을
                의미합니다. 3. “개인신용정보”란 금융거래 등 상거래에서 개인인
                신용정보주체의 신용, 거래내용, 거래능 력 등을 판단할 수 있는
                정보를 말합니다. 4. “정보제공자”란 『신용정보의 이용 및 보호에
                관한 법률』 제33조의2 조에 따라 신용정보를 전송할 의무가 있으며,
                이러한 의무에 따라 “이용자”의 “개인신용정보”를 전송하는 자를
                말합니다.
              </v-card-text>
              <v-divider></v-divider>
              <v-card-actions>
          ...
          <v-dialog v-model="dialog2" width="500">
            <v-card>
              ...
              >
              <v-card-text>
                제 7 조 (서비스 이용 통지) ① “은행”이 “이용자”에 대한 통지를
                하는 경우 이 약관에 별도 규정이 없는 한 “이용자”의 이메 일, 문자
                등의 방법으로 통지합니다. ② “은행”은 전체 “이용자”에 대하여
                통지가 필요한 경우 홈페이지, 모바일 어플리케이션 등에
                게시함으로써 제1항의 통지에 갈음할 수 있습니다. 다만,
                “이용자”에게 중대한 영향을 미치는 사항에 대하여는 이메일, 문자
                등의 방법으로 개별 통지합니다. 제 8 조 (이용 수수료) ① “은행”은
                사용자의 “서비스” 이용에 따른 수수료를 부과할 수 있습니다. ②
                “은행”은 수수료에 관한 사항을 홈페이지 등에 게시합니다. ③
                “은행”은 수수료를 변경하고자 하는 경우 이 약관 제16조를
                준용합니다.
              </v-card-text>
              <v-divider></v-divider>
              <v-card-actions>
